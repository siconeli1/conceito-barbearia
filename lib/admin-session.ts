...
function getSessionSecret() {
  ...
  if (!secret) {
    throw new Error('ADMIN_SESSION_SECRET ou ADMIN_PASSWORD deve estar definido.')
  }
...
export async function createAdminSessionCookie(maxAgeSeconds = DEFAULT_MAX_AGE_SECONDS) {
